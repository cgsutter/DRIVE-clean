...
model_path = "/home/csutter/DRIVE-clean/CNN/data_models_side_experiments" #HERE!!
...
adhoc_desc = "_TestHTRuns" # Default to empty string. Used as a desc "_TEST" "_SaveWeightsOnly" ad hoc to differentiate a test code run, added to file naming. 
one_off = False
