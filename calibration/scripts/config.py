dir_of_datacsvs = "/home/csutter/DRIVE-clean/downstream/data_preds" #HERE!!
...
classif_model =  "downstream" #HERE!! "CNN" or "downstream" or 'fcstOnly". A dir will be made to save the data and models to according to this classif model
