...
dir_of_datacsvs = "/home/csutter/DRIVE-clean/side_experiments_data_and_models/CNN/data_preds_expOneTrain"
...
classif_model =  "CNNexpOneTrain" #HERE!! "CNN" or "downstream" or 'fcstOnly" or for side experiments "CNNexpHalved", "CNNexpOneTrain". A dir will be made to save the data and models to according to this classif model
